...
export const AppFooter = () => {
  return (
    <footer className="dark bg-background text-foreground max-md:hidden md:p-6">
      <div className="container mx-auto max-w-screen-2xl">
        <div className="grid grid-cols-12 py-8 max-md:px-2">
          <div className="col-span-3 flex flex-col gap-4">
            ...
            <div>
              <Typography as="p">(123) 456-7890</Typography>
              <Typography
                variant="paragraph2"
                as="p"
              >
